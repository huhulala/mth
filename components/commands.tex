...
% \newcommand{\listing}[2]
% {
%   \lstinputlisting[caption={#2},label=lst:#1]{listings/#1}
% }
...
\newcommand{\refChapter}[1]{Chapter \ref{chap:#1}}
...
\newcommand{\refListing}[1]{Listing \ref{lst:#1}}
...
\newcommand{\conEf}[2]
{
  \llbracket \text{#1} \rrbracket \; #2
}

% abstract effect
\newcommand{\absEf}[2]
{
  \llbracket \text{#1} \rrbracket^\sharp \; #2
}